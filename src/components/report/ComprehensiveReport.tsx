  ...
  function ComprehensiveReport(
    ...
    return (
      ...
      >
        ...
        {/* Split-Pane Context Banner — Street View + Aerial Map */}
        {(streetViewUrl || staticMapUrl) && (
          <div className="grid grid-cols-2 gap-4 my-6 h-[220px] break-inside-avoid">
            {/* Street View Container */}
            {streetViewUrl && (
              <div className="w-full h-full rounded-lg overflow-hidden border border-zinc-200 bg-zinc-50 relative">
                <img
                  src={streetViewUrl}
                  alt="Street View"
